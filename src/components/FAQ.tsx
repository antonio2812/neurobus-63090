...
const FAQ = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "Não! A LucraAI foi desenvolvida para ser super intuitiva. Nossa interface em português simples permite que qualquer pessoa use, sem necessidade de conhecimento técnico.",
    },
    {
    ...
    },
    {
      ...
      answer: "Você pode cancelar a qualquer momento direto na plataforma, clicando no botão 'Cancelar assinatura'. Sem multas ou taxas.",
    },
    {
