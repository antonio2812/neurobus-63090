...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-400",
      // Aplicando a cor de destaque #ffc800 (accent) ao botão de fechar
      "text-[#ffc800] hover:text-[#ffc800]/80",
      className
    )}
    toast-close=""
    {...props}
...
export {
  type ToastPropsWithoutRef as ToastProps,
