...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      // Removendo rounded-full p-1 e focus:ring-2 para eliminar qualquer fundo ou anel branco/claro.
      // Mantendo apenas a cor accent no hover/focus.
      "absolute right-2 top-2 opacity-0 transition-opacity hover:text-accent focus:opacity-100 focus:outline-none",
