...
import ForbiddenWordsChat from "./forbidden-words/ForbiddenWordsChat";
import { useState } from "react";
import { cn } from "@/lib/utils";

interface ForbiddenWordsModalProps {
  children: React.ReactNode;
}

const ForbiddenWordsModal = ({ children }: ForbiddenWordsModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <ForbiddenWordsChat onBack={handleBack} />
      </DialogContent>
    </Dialog>
  );
};
