...
import SupplierFinderChat from "./supplier-finder/SupplierFinderChat";
import { useState } from "react";
import { cn } from "@/lib/utils";

interface SupplierFinderModalProps {
  children: React.ReactNode;
}

const SupplierFinderModal = ({ children }: SupplierFinderModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      >
        <SupplierFinderChat onBack={handleBack} />
      </DialogContent>
    </Dialog>
  );
};

export default SupplierFinderModal;